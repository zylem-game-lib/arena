...
import { LOBBY_COLOR_SWATCHES, swatchCss } from '../lobby-palette';
 ...
 */
const CHARACTER_ORDER: readonly CharacterClass[] = [
	'tank',
	'healer',
	'assassin',
];
...
const ArenaLobby: Component = () => {
	...
	const cycleClass = (dir: 1 | -1): void => {
		arenaLobbyStore.characterClass = step(
						...
						{(swatch) => {
							...
							return (
								<button
									...
									style={{
										background: swatchCss(swatch.value),
									}}
									onClick={() => {
										arenaLobbyStore.colorU32 = swatch.value;
									}}
			...
			<div class={styles.middle}>
				<aside class={styles.artPanel} aria-label="Character portrait">
					...
					<p class={styles.tagline}>
						{CHARACTER_TAGLINES[selectedClass()]}
					</p>
				</aside>

				<aside
					class={styles.statsPanel}
					aria-label="Character stats and specials"
				>
